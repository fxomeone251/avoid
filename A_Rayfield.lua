...
local settingsTable = {
	...
	System = {
		usageAnalytics = {Type = 'thelabelhahaha', Value = "Analytics are fully disabled due to using Avoid's Rayfield."},
	}
}
...
local function createSettings(window)
	...
	for categoryName, settingCategory in pairs(settingsTable) do
		...
		for _, setting in pairs(settingCategory) do
			...
			elseif setting.Type == 'thelabelhahaha' then
				setting.Element = newTab:CreateLabel(setting.Value, "info")
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			Dropdown.List.Template.UIStroke.Enabled = false
...
task.spawn(function()
	if not useStudio then
		print('Attempting to load boost...')
		local success, result = pcall(function()
