...
Datatables["S1"] = {
  ...
  ["Overrides"] = {"Animal Pool","Great White Shark","Great Hammerhead Shark","Whale Shark","Megalodon Default","Megalodon Ancient","The Kraken Pool","Orcas Pool","Forsaken Veil - Scylla","Whales Pool","Isonade","The Depths - Serpent"},
}
Datatables["S2"] = {
